<%@ page contentType="text/html; charset=UTF-8" %>
 ...
 <body topmargin="0" leftmargin="0">
         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              <a class="list" href="mailto:ein1027@nate.com">${board.name }</a> / <font size="2" face="돋움">${board.regdate.substring(0,10) } / ${board.readcnt }번 읽음</font>
  ...
  <script>
  	function del(){
  		var url = "board_delete?idx=${board.idx}"
  		var name = "board_delete"
  		var optin = "width = 500  height = 150"
  	window.open(url,name,optin)
  	}
  </script>
  </body>
  </html>
